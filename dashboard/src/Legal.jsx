...
const ISSUES_URL = 'https://github.com/your-username/moneyfest/issues'; // TODO: update to real repo URL
        ...
        <div className="min-h-screen bg-bg text-white">
            ...
            <main className="max-w-3xl mx-auto px-6 py-12">
                ...
                <Section title="The short version">
                    <p>
                        Moneyfest is a free, open-source AI clip generator. There are no accounts, no payments, and we
                ...
                <Section title="You are responsible for what you upload">
                    ...
                    <p>
                        ...
                        agree to indemnify Moneyfest and its contributors against any third-party claim arising from
                ...
                <Section title="Third-party APIs">
                    <p>
                        When you use a feature that requires it, Moneyfest forwards relevant data to the third-party
                ...
                <Section title="Self-hosted instances">
                    <p>
                        Moneyfest is open source and may be self-hosted. This notice applies only to the hosted
