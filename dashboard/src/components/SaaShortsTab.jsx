...
export default function SaaShortsTab({ geminiApiKey, groqApiKey, elevenLabsKey, falKey, uploadPostKey, uploadUserId }) {
  // Wizard state
  ...
  const handleAnalyze = async () => {
    ...
    if (!geminiApiKey && !groqApiKey) {
      setAnalyzeError('Gemini or Groq API key required. Set it in Settings.');
      return;
    }
